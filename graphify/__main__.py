...
# Accepts a relative name (".graph-feature") or an absolute path ("/shared/.graph").
...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("                            (default .graph/graph.json)")
        ...
        print("    --out <path>            output path (default: .graph/merged-graph.json)")
        ...
        print("  save-result             save a Q&A result to .graph/memory/ for graph feedback loop")
        ...
        print("    --memory-dir DIR        memory directory (default: .graph/memory)")
        print("  reflect                 aggregate .graph/memory/ outcomes into a deterministic lessons doc")
        print("    --memory-dir DIR        memory directory (default: .graph/memory)")
        print("    --out FILE              output path (default: .graph/reflections/LESSONS.md)")
        ...
        print("    --out DIR, --output DIR output dir (default: <path>); writes <DIR>/.graph/")
        ...
        print("  learn [PATH]            generate multi-perspective learning content for graph.html's")
        print("                          learn tab: business flows / architecture / feature deep-dives")
        print("                          (.graph/learn.json + .graph/features/*.md)")
