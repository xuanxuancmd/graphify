...
'@ | & (Get-Content .graph\.graphify_python) -
Remove-Item -Force -ErrorAction SilentlyContinue .graph\.graphify_detect.json, .graph\.graphify_extract.json, .graph\.graphify_ast.json, .graph\.graphify_semantic.json, .graph\.graphify_analysis.json
